...
import components.elements.interfaces.IScrollable;
...
public class WallComponent extends BorderContainer implements IScrollable
{
	public function WallComponent()
	{
		super();
	...
	public function addComponent(element:WallComponent):WallComponent  {
		return childrenContainer.addElement(element) as WallComponent;
	}
	
	
	public function addComponentAt(element:WallComponent, index:int):WallComponent  {
		return childrenContainer.addElementAt(element, index) as WallComponent;
	}
	...
	public function removeComponent(element:WallComponent):WallComponent  {
		return childrenContainer.removeElement(element) as WallComponent;
	}
	
	
	public function removeComponentAt(index:int):WallComponent  {
		return childrenContainer.removeElementAt(index) as WallComponent;
	}
	...
	public function getComponentIndex(element:WallComponent):int  {
