...
$(document).on('wallready', function() {
    $(".sheetBox").children().on('copy cut', function(e) {
      ...
      data = {
        'type': 'text',
        'title': $(sheet).find(".sheetTopBar h1").html(),
        'content': $(sheet).find(".sheetText textarea").val()
      }
