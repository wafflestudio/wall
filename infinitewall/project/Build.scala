...
object ApplicationBuild extends Build {
	...
	val appDependencies = Seq(
			...
			"net.fwbrasil" % "activate-core_2.10" % "1.4.1",  //exclude("org.scala-stm", "scala-stm_2.10.0"),
			"net.fwbrasil" % "activate-play_2.10" % "1.4.1",  //exclude("org.scala-stm", "scala-stm_2.10.0"),
			"net.fwbrasil" % "activate-jdbc_2.10" % "1.4.1",  //exclude("org.scala-stm", "scala-stm_2.10.0"),
