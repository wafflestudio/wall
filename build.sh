...
BUILD_ID=0 nohup $TARGET_PATH/bin/infinitewall -Dhttp.port=9000 -Djdk.tls.disabledAlgorithms="RC4" -DapplyEvolutions.default=false -Dsecuresocial.ssl=true > log.log 2>&1 &
