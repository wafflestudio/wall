...
# start the server
play stage
BUILD_ID=0 nohup target/start -Dhttp.port=9000 -Dhttps.port=9443 -Dhttps.keyStore=scalableidea_com.jks -Dhttps.keyStorePassword="scalableidea302" -DapplyEvolutions.default=false -Dsecuresocial.ssl=true > log.log 2>&1 &
